...
namespace MISA.Service
{
    public class EmployeeService : BaseService<Employee>, IEmployeeService
    {
        ...
        protected override bool ValidateData(Employee employee, ErrorMsg errorMsg = null)
        {
            ...
            //{
            //    errorMsg.devMsg.Add(MISA.Common.Properties.Resources.ErrorService_NullPhoneNumber_dev);
            //    errorMsg.userMsg.Add(MISA.Common.Properties.Resources.ErrorService_NullPhoneNumber_user);
            //}
            //isExist = _employeeRepository.CheckPhoneNumberExist(employee.PhoneNumber);
            //if (isExist == true)
            //{
            //    errorMsg.devMsg.Add(MISA.Common.Properties.Resources.ErrorService_DuplicatePhoneNumber_dev);
            //    errorMsg.userMsg.Add(MISA.Common.Properties.Resources.ErrorService_DuplicatePhoneNumber_user);
            //    isValid = false;
            //}
